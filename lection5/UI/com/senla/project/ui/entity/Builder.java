...
public class Builder {
    ...
    public void build() {
        ...
        //Mechanic Menu
        MenuItem backToMain = new MenuItem(navigator);
        ...
        MenuItem addMechanics = new MenuItem(navigator);
